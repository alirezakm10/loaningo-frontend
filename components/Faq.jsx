...
console.log('f',filteredSearch)
  ...
  return (
    <section
      className={`relative container  text-whiteloan ${
        faqPage ? "mt-[20px]" : "my-[100px] py-4"
      }`}
    >
      {faqPage && (
          ...
          <ol className="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
              <div className="flex items-center">
                ...
                <p className="ml-1 text-sm font-medium text-gray-700 hover:text-blueloan md:ml-2 dark:text-gray-400 dark:hover:text-white">
                  {t("faqTitle")}
                </p>
              </div>
            </li>
